...
You must be at least 18 years old and legally permitted to use blockchain-based financial services in your jurisdiction.

By using the Platform, you represent that your participation does not violate any applicable laws, regulations, or sanctions.
...
Users are solely responsible for their own decisions and assume all risks related to blockchain transactions.

### 4. User Responsibility

You are fully responsible for:

* The security of your wallets, keys, and on-chain interactions.
...
* Continuous operation or uptime
* Accuracy of AI models or trading outputs
* Profitability of agents or tokens
* Error-free smart contract execution

Your use of the Services is entirely at your own risk.

### 6. Assumption of Risk

Use of blockchain-based protocols carries inherent risks, including but not limited to:

* Smart contract bugs or exploits
* AI agent misbehavior or poor performance
